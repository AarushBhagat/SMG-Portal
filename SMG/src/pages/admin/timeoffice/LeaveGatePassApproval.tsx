    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#042A5B] to-[#0B4DA2] rounded-3xl p-8 text-white shadow-xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Final Approval - Leave & Gate Pass</h1>
            <p className="text-white/80">Review and approve employee requests after HOD approval</p>
          </div>
          ...
          <table className="w-full table-fixed">
            <thead className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
              <tr>
                ...
                <th className="w-40 px-4 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">HOD Status</th>
                ...
                <tr key={request.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500 truncate">{request.hodApprover}</p>
                    </div>
                  </td>
                  <td className="px-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 bg-green-50 border border-green-200 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-green-700 font-semibold mb-1">HOD Approval</p>
                      <p className="font-bold text-green-800">{selectedRequest.hodApprover}</p>
                      <p className="text-sm text-green-600 mt-1">Status: {selectedRequest.hodStatus}</p>
                    </div>
                  </div>
                </div>
              </div>
