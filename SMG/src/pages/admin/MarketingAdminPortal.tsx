        ...
        <aside className="hidden lg:flex w-[240px] bg-[#042A5B] flex-col shadow-2xl">
          <nav className="px-3 py-6 space-y-1 flex-1 overflow-y-auto">
            <div className="space-y-1">
              <p className="px-3 text-[10px] font-bold text-[#87CEEB]/60 uppercase tracking-wider mb-2 whitespace-nowrap">Overview</p>
            ...
            <div className="space-y-1">
              <p className="px-3 text-[10px] font-bold text-[#87CEEB]/60 uppercase tracking-wider mb-2 whitespace-nowrap">Campaigns</p>
              ...
              >
                ...
                <span className="whitespace-nowrap font-medium text-white">Campaign Status</span>
              </button>
              ...
              >
                ...
                <span className="whitespace-nowrap font-medium text-white">New Campaigns</span>
              </button>
              ...
              >
                ...
                <span className="whitespace-nowrap font-medium text-white">Ongoing Campaigns</span>
              </button>
            </div>

            <div className="space-y-1">
              <p className="px-3 text-[10px] font-bold text-[#87CEEB]/60 uppercase tracking-wider mb-2 whitespace-nowrap">Management</p>
              ...
              >
                ...
                <span className="whitespace-nowrap font-medium text-white">Marketing Agencies</span>
              </button>
            </div>
